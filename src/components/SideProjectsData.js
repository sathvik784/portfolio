const projectData = [
  {
		...
		"Description": "Created a honeypot system to study how different SSH banners influence attacker behavior and track command execution patterns.",
		"GitHub": "https://github.com/HACS200-HoneyPot-Project",
		"PDFLink": "https://docs.google.com/document/d/1n3fuHgBWw82nLBBH5Km4L7ShGSEvoisJoTFg5Bd_mb0/export?format=pdf",
		"techStack": ["Bash", "Unix/Linux", "Python"]
  },
	{
		"id": 2,
