...
const SideProjectCard = ({ projectData }) => {
    return (
		<motion.div
			...
			viewport={{ once: true }}
			className="group bg-white rounded-xl p-8 shadow-sm hover:shadow-lg transition-all duration-300 border border-gray-200 hover:border-gray-300 flex flex-col w-full max-w-sm min-h-[550px]"
		>
			{/* Title */}
